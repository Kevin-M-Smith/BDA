...
<a onclick='$("pre").slideToggle("slow");' >Show / Hide Source</a>
</li></ul>
</div>
...
```{r fig3a, dev='png', fig.height=4, fig.width=10, warning=FALSE, htmlcap=4, fig.cap="Total and partial correlograms.", cache=TRUE}
...
### Differencing
```{r, dev='png', fig.height=4, fig.width=10, fig.cap="Differenced (d=12) Monthly Mean Flow Series", htmlcap=5, cache=TRUE, eval=TRUE}
...
```{r, fig.cap = "Total and partial correlograms for the differenced (d=12) series.", htmlcap=6, fig.height=4, fig.width=10}
